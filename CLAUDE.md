...
- מקור הנתונים: LinkedIn guest jobs API (`jobs-guest/jobs/api/seeMoreJobPostings/search`), ללא התחברות. לשמור על קצב מנומס: עצירה מוקדמת על עמוד שכולו מוכר, השהיות בין עמודים.
